                            ...
                            <div class="dokan-form-top-area">
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    ...
                                    <div class="dokan-form-group">
                                        ...
                                        <label for="post_title" class="form-label"><?php esc_html_e( 'Название исполнителя. Название альбома (релиза). Год издания (переиздания).', 'dokan-lite' ); ?></label>
                                    ...
                                    <div class="dokan-form-group">
                                        <label for="product_tag" class="form-label"><?php esc_html_e( 'Исполнитель', 'dokan-lite' ); ?></label>
                                        <?php
									...
									<div>
		<div style="display: inline;"><?php $image = wp_get_attachment_image_src(get_field('photo_ispolnitel'), 'thumbnail'); ?>
<img src="<?php echo $image[0]; ?>" alt="<?php echo get_the_title(get_field('photo_ispolnitel')) ?>" />
</div>

<div style="display: inline;"><?php $image = wp_get_attachment_image_src(get_field('photo_ispolniteldva'), 'thumbnail'); ?>
<img src="<?php echo $image[0]; ?>" alt="<?php echo get_the_title(get_field('photo_ispolniteldva')) ?>" />
</div>
<!-- вывод полей -->
<label for="cod_music_yandex" class="form-label">Краткое описание альбома, исполнителя.</label>

<?php wp_editor(get_post_meta( $post->ID, '_custom_desc', true ), 'custom_desc', array(
			'wpautop'       => 0,
			'media_buttons' => 0,
...
?>
                            ...
                            <div class="dokan-product-short-description">
                                <label for="post_excerpt" class="form-label"><?php esc_html_e( 'Ссылка альбома (релиза) Яндекс.Музыка или Apple Music', 'dokan-lite' ); ?></label>
                                <?php wp_editor( $post_excerpt , 'post_excerpt', apply_filters( 'dokan_product_short_description', array( 'editor_height' => 50, 'quicktags' => false, 'media_buttons' => false, 'teeny' => false, 'tinymce' => false, 'editor_class' => 'post_excerpt' ) ) ); ?>
                            </div>

                            <div class="dokan-product-description">
                                <label for="post_content" class="form-label"><?php esc_html_e( 'Ссылка видео Youtube', 'dokan-lite' ); ?></label>
                                <?php wp_editor( $post_content , 'post_content', apply_filters( 'dokan_product_description', array( 'editor_height' => 50, 'quicktags' => false, 'media_buttons' => false, 'teeny' => false, 'tinymce' => false, 'editor_class' => 'post_content' ) ) ); ?>
                            </div>
...
<div class="dokan-clearfix"></div>
<style>
div.dokan-product-inventory.dokan-edit-row {display:none;}
div.dokan-other-options.dokan-edit-row.dokan-clearfix  {display:none;}
div.dokan-form-group.dokan-product-type-container.show_if_simple {display:none !important;}
span.vendor-earning {display:none;}
